...
def importance_sampling(a,a2):
    # Create alternative uniform normal dist A -- g(x)
    g_xx = stats.beta(a, 1)
...
def plot_sample_sizes(ss, ssz, method):
    plt.plot(ss, ssz, c='red', label=method)
...
if __name__ == '__main__':
    ...
    if run_sample_sizes:
        ...
        for method in methods:
            ...
            plot_sample_sizes(sample_sizes, sample_size_area, str(method.__name__))
        plt.legend()
